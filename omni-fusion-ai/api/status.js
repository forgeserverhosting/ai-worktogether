...
import { getOpenRouterCatalog, openRouterAllowPaid } from '../server/providers/openrouter.js';
...
export default async function handler(req, res) {
  ...
  if (process.env.OPENROUTER_API_KEY) {
    ...
    openRouter = {
      ...
      models: compact.sort((a, b) => Number(b.free) - Number(a.free) || a.author.localeCompare(b.author) || a.name.localeCompare(b.name)),
