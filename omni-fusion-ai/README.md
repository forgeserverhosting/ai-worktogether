# OmniFusion Motion Studio V17

OmniFusion V17 is a compact, website-first AI studio designed to produce better finished websites through specialization, persistent project memory, multiple free OpenRouter models, actual files, rendered review, precise repairs, and deterministic release checks.
...
## V17 interface and motion upgrade

V17 keeps the same compact workflow while completely polishing OmniFusion's own interface:

- floating glass workspace panels with clearer visual hierarchy
- smooth page, panel, modal, chat, card, and status transitions
- animated ambient background lighting and a living OmniFusion mark
- polished hover, press, focus, progress, loading, and success states
- animated chat questions, concept cards, team handoffs, files, and validation results
- a more premium composer, preview frame, sidebars, and mobile layout
- automatic motion for newly rendered AI messages and project artifacts
- respectful reduced-motion support for accessibility

All workflow, intelligence, testing, packaging, and free-model features from V16 remain intact.
